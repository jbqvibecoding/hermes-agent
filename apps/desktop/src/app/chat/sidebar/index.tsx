...
import { type AppView, ARTIFACTS_ROUTE, CREW_ROUTE, MESSAGING_ROUTE, SKILLS_ROUTE } from '../../routes'
...
const SIDEBAR_NAV: SidebarNavItem[] = [
  ...
  { id: 'crew', label: '', icon: props => <Codicon name="organization" {...props} />, route: CREW_ROUTE },
