import { R as Er, g as Yu, m as pe, c as Cd, d as ye, e as ke, b as Me, f as qu, h as Ka, i as Vt, j as Id, u as Ce, k as en, a as Ae, l as $e, S as _i, r as Zi, n as Vu } from "./chunk-workspace-0HzLPxpa.js";
const Fr = (
...
`; ) t--;
  return e.slice(0, t);
}, Ox = Vu(() => import("./chunk-highlighted-body-KPVGNVTW-DBtYIKRj.js").then((e) => ({ default: e.HighlightedCodeBlockBody }))), Bc = ({ code: e, language: t, className: n, children: r, isIncomplete: i = !1, startLine: a, lineNumbers: s, ...u }) => {
